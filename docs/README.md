...
Guides for working on **edincenanovic.com**. For the project overview, stack and
local setup, see the [root README](../README.md).

- **[Authoring content](authoring.md)** — add a blog post, and change the site's
